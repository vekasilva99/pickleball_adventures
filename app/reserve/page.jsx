...
aux+=guests[i].length
  ...
  return (
    <div className={styles.main}>
      <div className={showCancellation ? `${styles.overlay}`: `${styles.overlay} ${styles.noShow}`} onClick={()=>{setShowCancellation(false)}}>
        <div className={styles.modal}>
          <p>Cancellation Policy <br/>
(Non Refundable Deposit)<br/>
If you cancel your reservation after a specific date, you may be subject to cancellation charges.</p>
<div className={styles.modalTable}>
<div className={styles.modalRow}>
<div className={styles.modalColumn}><p>Cancel After</p></div>
<div className={styles.modalColumn}><p>Penalty</p></div>
</div>
<div className={styles.modalRow}>
<div className={styles.modalColumn}><p>95 or more days prior to the trip
</p></div>
<div className={styles.modalColumn}><p>Full Refund (excluding $150 administrative fee)</p></div>
</div>
<div className={styles.modalRow}>
<div className={styles.modalColumn}><p>60 or more days prior to the trip</p></div>
<div className={styles.modalColumn}><p>50% Refund</p></div>
</div>
<div className={styles.modalRow}>
<div className={styles.modalColumn}><p>30 days or les prior to the trip</p></div>
<div className={styles.modalColumn}><p>No Refund</p></div>
</div>
</div>
        </div>
      </div>
