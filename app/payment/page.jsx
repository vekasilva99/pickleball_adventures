    ...
    if (duplicateElementa.length > 0) {
      ...
      for (let i = 0; i < guestsInfo.length; i++) {
        let roomAux = {
          room_number: i + 1,
          guests: [],
          price: calculateTotalPerRoom(guests[i]),
        };
        for (let j = 0; j < guestsInfo[i].length; j++) {
    ...
    <div className={styles.main}>
      ...
      <div className={styles.row}>
        <div
          className={
            showDetails
              ? `${styles.column1} ${styles.showDetails}`
              : `${styles.column1}`
          }
        >
          <div className={styles.sidebar}>
            ...
            <button
              className={
                !showDetails
                  ? styles.back
                  : `${styles.back} ${styles.noShowButton}`
              }
            >
              Go Back
            </button>
            ...
            >
              <div
                className={`${styles.sidebarElement} ${styles.currentOption}`}>
                <h3>Rooms</h3>
