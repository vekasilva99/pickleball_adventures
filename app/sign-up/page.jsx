          ...
          <div className={styles.inputContainer}>
            <div className={styles.input}>
              ...
              <input
                ...
                className={first_nameError != undefined ? styles.invalid : ""}
              />
              <h2>First Name</h2>
            </div>
            <div className={styles.input}>
              ...
              <input
                ...
                className={last_nameError != undefined ? styles.invalid : ""}
              />
              <h2>Last Name</h2>
            </div>
            <div className={styles.input}>
            ...
            <div className={styles.input}>
              ...
              <input
                ...
                className={emailError != undefined ? styles.invalid : ""}
              />
              <h2>Email</h2>
            </div>
            <div className={styles.input}>
              ...
              <div className={styles.inputGroup}>
                ...
                >
                  <input
                    ...
                    className={numberError != undefined ? styles.invalid : ""}
                  />
                  <h2>Phone</h2>
                </div>
              </div>
            ...
            <div className={styles.input}>
              ...
              <input
                ...
                className={passwordError != undefined ? styles.invalid : ""}
              />
              <h2>Password</h2>
            </div>
            <div className={styles.input}>
              ...
              <input
                ...
                className={password2Error != undefined ? styles.invalid : ""}
              />
